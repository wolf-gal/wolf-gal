...
My favs characters:
Melly Plinius (IDV), Qi Xi (IDV) ; Anna (DBD), Caleb Quinn (DBD), Vriska Serket (HS) ; Whisper the Wolf (STH* IDW), Blaze the Cat (STH), Rouge the Bat (STH) ; Lapis Lazuli (SU) ; Zooble (TADC).

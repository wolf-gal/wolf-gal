...
My favs characters:
Melly Plinius (IDV), Qi Xi (IDV) ; Anna (DBD), Caleb Quinn (DBD), Amanda Young (DBD* The SAW) ; Vriska Serket (HS) ; Whisper the Wolf (STH* IDW), Rouge the Bat (STH) ; Lapis Lazuli (SU) ; Zooble (TADC).

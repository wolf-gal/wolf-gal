...
My favs characters:
Melly Plinius (IDV), Yidhra (IDV), Qi Xi (IDV) ; Anna (DBD), Caleb Quinn (DBD), Amanda Young (DBD* The SAW) ; Kate the Chaser (SLENDERVERSE* CREEPYPASTA), Jane Everlasting\the killer (CREEPYPASTA) ; Vriska Serket (HS) ; Whisper the Wolf (STH* IDW) ; Zooble (TADC) ; Makoto Niijima (P5), Futaba Sakura (P5) ; Painwheel (SG) ; Marie (SPLATOON), Shiver (SPLATOON3).

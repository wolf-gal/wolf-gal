...
My favs characters:
Melly Plinius (IDV), Qi Xi (IDV) ; Kanaya Maryam (HS), Feferi Peixes (HS( ; Whisper the Wolf (STH* IDW), Blaze the Cat (STH), Rouge the Bat (STH) ; Lapis Lazuli (SU) ; Zooble (TADC).

...
My favs characters:
Melly Plinius (IDV), Yidhra (IDV), Qi Xi (IDV) ; Anna (DBD), Caleb Quinn (DBD), Amanda Young (DBD* The SAW) ; Kate the Chaser (SLENDERVERSE* CREEPYPASTA) ; Vriska Serket (HS) ; Whisper the Wolf (STH* IDW) ; Lapis Lazuli (SU) ; Zooble (TADC) ; Makoto Niijima (P5) ; Painwheel (SG) ; Marie (SPLATOON), Shiver (SPLATOON3).

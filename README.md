...
Most of the time, just observe other players or sittin with my closest friends...
...
My favs characters:
Melly Plinius\Queen Bee (IDV), Qi Xi (IDV) ; Anna (DBD), Caleb Quinn (DBD), Amanda Young (DBD* The SAW) ; Vriska Serket (HS) ; Whisper the Wolf (STH* IDW), Rouge the Bat (STH) ; Lapis Lazuli (SU) ; Zooble (TADC).
